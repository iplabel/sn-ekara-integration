...
type AlertData = {
  ...
  end_alert_reasons: EndAlertReason;
  product: string;
...
declare namespace snGlobal {
  ...
  class Workflow {
    ...
    getReturnValue(workflowID: string, amount: number, result: boolean): object;
...
declare namespace servicenow {
  ...
  interface GlideSystem {
    ...
    getProperty(key: string, altobject?: object): object;
